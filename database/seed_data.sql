...
('alex.brown@vanderbilt.edu', '$2a$10$iCsqOyw6AQhmnuhBkcuFoeJvTWjl.vTVOVDu845klfjtZywXgZSqS', 'Alex Brown', '(615) 555-0110', 'prefer_not_to_answer', 36.1426, -86.8038, 'Vanderbilt Commons, Nashville, TN', 'student', 6),
...
INSERT INTO offers (user_id, title, description, location_lat, location_lng, location_address, target_gender, delivery_available, status, available_from, available_until) VALUES
-- Offer 1: Sarah - Food and blankets
(1, 'Hot Meals & Warm Blankets Available', 'Have extra food and blankets from emergency prep kit. Can help multiple people!', 36.1447, -86.8027, 'Vanderbilt Commons Center', NULL, true, 'active', NOW(), NOW() + INTERVAL '3 days'),
-- Offer 2: Mike - Charging station and WiFi
(2, 'Power Bank Charging & WiFi Access', 'Have multiple power banks and home WiFi. Come by anytime!', 36.1433, -86.8015, 'Kissam Center', NULL, false, 'active', NOW(), NOW() + INTERVAL '2 days'),
-- Offer 3: Emma - Temporary shelter
(3, 'Spare Room Available for Emergency Stay', 'Have a spare bedroom and bathroom. Safe space for 1-2 people.', 36.1373, -86.7970, 'Hillsboro Village', NULL, false, 'active', NOW(), NOW() + INTERVAL '5 days'),
-- Offer 4: James - Medical supplies
(4, 'First Aid & Medical Supplies', 'Work at med center. Have extra first aid supplies, medications (OTC), and medical advice.', 36.1462, -86.8025, 'Vanderbilt Medical Center', NULL, true, 'active', NOW(), NOW() + INTERVAL '7 days'),
-- Offer 5: David - Transportation
(5, 'Car Rides Around Nashville Area', 'Can provide rides to grocery stores, pharmacies, or shelters. Have SUV with space.', 36.1484, -86.8003, 'West End Avenue', NULL, true, 'active', NOW(), NOW() + INTERVAL '2 days'),
-- Offer 6: Maria - Clothes and toiletries
(6, 'Winter Clothes & Toiletries', 'Cleaned out closet - have coats, sweaters, hygiene products. All sizes available.', 36.1394, -86.8015, '21st Avenue South', NULL, true, 'active', NOW(), NOW() + INTERVAL '4 days'),
-- Offer 7: Chris - Hot showers and laundry
(7, 'Hot Shower & Laundry Access', 'Have working water heater and washer/dryer. Can accommodate a few people per day.', 36.1627, -86.7816, 'Downtown Nashville', NULL, false, 'active', NOW(), NOW() + INTERVAL '3 days'),
-- Offer 8: Sophia - Groceries and water
(8, 'Groceries, Bottled Water & Snacks', 'Stocked up before storm. Have way too much - happy to share!', 36.1380, -86.7985, 'Edgehill Village', NULL, true, 'active', NOW() + INTERVAL '1 day', NOW() + INTERVAL '6 days'),
-- Offer 9: Alex - Phone charging and internet
(9, 'Device Charging Station + Internet', 'Set up charging station with multiple outlets. Fast WiFi available too.', 36.1426, -86.8038, 'Vanderbilt Commons', NULL, false, 'active', NOW(), NOW() + INTERVAL '2 days'),
-- Offer 10: Ryan - Baby supplies
(10, 'Baby Formula, Diapers & Supplies', 'Have extra baby supplies from our emergency kit. Sizes newborn to 2T.', 36.1420, -86.8045, 'Peabody Campus', NULL, true, 'active', NOW(), NOW() + INTERVAL '5 days');
...
(2, 'wifi_access', 5, 5, 'available', 'WiFi access - password provided'),
-- Offer 3 items (Emma)
...
(4, 'medical', 10, 10, 'available', 'Medical consultation and advice'),
-- Offer 5 items (David)
...
(6, 'female_hygiene_products', 15, 15, 'available', 'Pads, tampons, and hygiene essentials'),
-- Offer 7 items (Chris)
(7, 'wifi_access', 5, 5, 'available', 'Guest WiFi for visitors using the space'),
(7, 'clothes', 3, 3, 'available', 'Fresh towels and clean clothing basics'),
-- Offer 8 items (Sophia)
(8, 'food', 30, 30, 'available', 'Canned goods, pasta, rice'),
(8, 'water', 48, 48, 'available', 'Cases of bottled water'),
(8, 'food', 20, 20, 'available', 'Snacks and granola bars'),
-- Offer 9 items (Alex)
(9, 'power', 20, 20, 'available', 'Multiple charging cables (USB-C, Lightning, Micro-USB)'),
(9, 'wifi_access', 10, 10, 'available', 'High-speed WiFi access'),
-- Offer 10 items (Ryan)
(10, 'baby_care', 12, 12, 'available', 'Baby formula (various brands)'),
(10, 'baby_care', 50, 50, 'available', 'Diapers (newborn, size 1, size 2)'),
(10, 'baby_care', 10, 10, 'available', 'Baby wipes and supplies');

-- ============================================
-- REQUESTS (People needing help)
-- ============================================

INSERT INTO requests (user_id, title, description, urgency_level, location_lat, location_lng, location_address, target_gender, status) VALUES
-- Request 1: Ashley - Critical - No power, need food
(5, 'URGENT: No Power, Need Food & Water', 'Been without power for 2 days. Running low on food and water. Have two elderly roommates.', 'critical', 36.1439, -86.8055, 'Branscomb Quad, Vanderbilt', NULL, 'active'),
-- Request 2: Rachel - High - Need transportation to pharmacy
(9, 'Need Ride to Pharmacy ASAP', 'Need to pick up prescription medication. Cannot walk due to injury. Pharmacy on West End.', 'high', 36.1493, -86.7977, 'Music Row', NULL, 'active'),
-- Request 3: Jessica - Medium - Need warm clothes
(11, 'Need Winter Clothes for Family', 'Lost power and heating. Need warm clothes and blankets for family of 3 (2 adults, 1 child).', 'medium', 36.1450, -86.8010, 'Alumni Lawn, Vanderbilt', NULL, 'active'),
-- Request 4: Tyler - High - Need phone charging
(14, 'Phone Battery Dead - Need Charging', 'Phone is my only communication with family. Need place to charge ASAP.', 'high', 36.1455, -86.8020, 'Stevenson Center', NULL, 'active'),
-- Request 5: Olivia - Critical - Need baby supplies
(15, 'CRITICAL: Need Baby Formula & Diapers', 'Running out of formula and diapers for 6-month-old baby. Stores are closed.', 'critical', 36.1445, -86.8000, 'Blair School of Music', NULL, 'active'),
-- Request 6: Sarah - Low - Need laundry access
(1, 'Looking for Laundry Facilities', 'Power out, need to wash clothes. Not urgent but would be helpful.', 'low', 36.1447, -86.8027, 'Vanderbilt Commons Center', NULL, 'active'),
-- Request 7: Mike - Medium - Need hot meals
(2, 'Need Hot Food for Group', 'Hosting 5 students without power. Need hot meals or access to working kitchen.', 'medium', 36.1433, -86.8015, 'Kissam Center', NULL, 'active'),
-- Request 8: Ashley - High - Need medical supplies
(5, 'Need First Aid Supplies', 'Minor injury needs attention. Need bandages, antiseptic, pain relievers.', 'high', 36.1439, -86.8055, 'Branscomb Quad, Vanderbilt', NULL, 'active'),
-- Request 9: Rachel - Medium - Need temporary shelter
(9, 'Need Place to Stay for 1-2 Nights', 'Apartment has no heat or water. Looking for temporary shelter until repairs done.', 'medium', 36.1493, -86.7977, 'Music Row', NULL, 'active'),
-- Request 10: Tyler - Low - Need WiFi access
(14, 'Need Internet to Submit Assignment', 'Need WiFi access to submit online coursework. Deadline in 2 days.', 'low', 36.1455, -86.8020, 'Stevenson Center', NULL, 'active'),
-- Request 11: Olivia - Critical - Multiple needs
(15, 'CRITICAL: Multiple Urgent Needs', 'Single parent with 2 kids. Need food, water, blankets, and warmth. Power been out 3 days.', 'critical', 36.1445, -86.8000, 'Blair School of Music', NULL, 'active'),
-- Request 12: Jessica - High - Transportation to shelter
(11, 'Need Ride to Emergency Shelter', 'Family needs transport to warming shelter downtown. Have luggage and pet carrier.', 'high', 36.1450, -86.8010, 'Alumni Lawn, Vanderbilt', NULL, 'active');
...
(5, 'baby_care', 6, 0, 'pending', 'Baby formula - any brand'),
(5, 'baby_care', 30, 0, 'pending', 'Size 2 diapers'),
(5, 'baby_care', 2, 0, 'pending', 'Baby wipes'),
-- Request 6 items (Sarah - low)
(6, 'clothes', 2, 0, 'pending', 'Access to washer and dryer'),
...
(10, 'wifi_access', 1, 0, 'pending', 'WiFi access for a few hours'),
